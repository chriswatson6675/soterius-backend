 ...
 *
 * Applies 005_dataset_governance.sql to the Supabase database.
 *
...
const SQL_FILE = path.join(__dirname, '../../../db/migrations/005_dataset_governance.sql');
...
(async () => {
  ...
  try {
    console.log('Applying 005_dataset_governance.sql...');
