...
const complianceEvidenceRouter = require('./api/routes/compliance-evidence');
const internalObservatoryRouter = require('./api/routes/internal-observatory');
...
app.use('/api/internal/observatory', internalObservatoryRouter);
